        ...
        <div className="backdrop-blur-md bg-[rgba(30,20,40,0.55)] rounded-2xl border border-white/10 shadow-[0_15px_35px_rgba(0,0,0,0.5)] p-10 text-center">
          ...
          <div className="mb-10 flex justify-center">
            <Image
              ...
              width={280}
              height={100}
              className="h-auto drop-shadow-[0_0_15px_rgba(37,99,235,0.6)]"
              priority
            />
          </div>
          ...
          <div className="mt-10 text-base text-[#ccc]">
            New here?{" "}
            <Link href="/register" className="text-[#2563eb] font-bold no-underline border-b-2 border-transparent transition-all duration-300 hover:border-[#2563eb] hover:text-white">
              Create Account
            </Link>
          </div>
        </div>
