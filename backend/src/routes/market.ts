...
marketRouter.post("/buy/:itemId", authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
...
marketRouter.post("/sell/:inventoryId", authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
...
marketRouter.post("/equip/:inventoryId", authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
    const inventoryId = Number(req.params.inventoryId);
