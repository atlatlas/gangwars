...
const shopItems = [
  ...
  { name: "Sniper Rifle", type: "arm" as const, description: "Precision from a distance. They never see it coming.", buyPrice: 80000, sellPrice: 40000, minLevel: 28, minRespect: 500, effects: JSON.stringify({ crimeBonus: 18, pvpPower: 50 }), slot: "weapon" as const },
  // Drugs (6)
  ...
  { name: "Lieutenant", type: "footman" as const, description: "Your right hand. Commands respect and delivers results.", buyPrice: 75000, sellPrice: 18750, minLevel: 25, minRespect: 250, effects: JSON.stringify({ crimeBonus: 10, pvpPower: 10 }), slot: null },
  // Drug Dealers (4)
  ...
  { name: "Cartel Contact", type: "drug_dealer" as const, description: "Well-connected supplier. Produces 30 units per hour with better drugs.", buyPrice: 100000, sellPrice: 0, minLevel: 25, minRespect: 1000, effects: JSON.stringify({ drugProduction: 30 }), slot: null },
  { name: "International Kingpin", type: "drug_dealer" as const, description: "Global empire. Produces 75 units per hour of premium product.", buyPrice: 500000, sellPrice: 0, minLevel: 35, minRespect: 5000, effects: JSON.stringify({ drugProduction: 75 }), slot: null },
  ...
  { name: "Elite Companion", type: "hoe" as const, description: "High-end talent. Politicians and CEOs pay top dollar. $1,500/hr.", buyPrice: 150000, sellPrice: 37500, minLevel: 22, minRespect: 1000, effects: JSON.stringify({ incomePerHour: 1500 }), slot: null },
  { name: "Madame", type: "hoe" as const, description: "Runs her own operation. Manages a stable and delivers $4,000/hr.", buyPrice: 500000, sellPrice: 125000, minLevel: 30, minRespect: 5000, effects: JSON.stringify({ incomePerHour: 4000 }), slot: null },
  ...
  { name: "King Pin", type: "pimp" as const, description: "Top-tier operator. Runs the game. Protects 5 hoes.", buyPrice: 350000, sellPrice: 87500, minLevel: 26, minRespect: 2500, effects: JSON.stringify({}), slot: null },
];
...
const skillDefs = [
  { name: "Guerrilla Warfare", description: "Master urban combat tactics. Increases PvP attack power.", statUsed: "strength" as const, baseXpPerTrain: 15, turnCost: 5, maxLevel: 100, difficulty: 1.0 },
  { name: "Chemistry", description: "Expertise in narcotics. Better drug trade prices and reduced bust chance.", statUsed: "intelligence" as const, baseXpPerTrain: 12, turnCost: 6, maxLevel: 100, difficulty: 1.2 },
  { name: "Sixth Sense", description: "Heightened awareness. Reduces damage taken in PvP.", statUsed: "agility" as const, baseXpPerTrain: 10, turnCost: 8, maxLevel: 100, difficulty: 1.5 },
  { name: "Women's Studies", description: "Understanding of the streets oldest trade. Boosts passive income.", statUsed: "charisma" as const, baseXpPerTrain: 10, turnCost: 7, maxLevel: 100, difficulty: 1.3 },
  { name: "Sexual Education", description: "Advanced knowledge for maximum passive income returns.", statUsed: "charisma" as const, baseXpPerTrain: 8, turnCost: 10, maxLevel: 100, difficulty: 1.8 },
];
...
// Upsert 10 gang operation definitions
const operations = [
  { name: "Street Protection Racket", description: "Extort local businesses for weekly protection money.", skillId: gwSkill.id, minSkillLevel: 15, dailyTaskType: "pvp_win" as const, dailyTaskDescription: "Win a mugging or ambush PvP attack", incomePerMemberL1: 3000, minSkillLevelL2: 35, incomePerMemberL2: 7000, upgradeCostL1toL2: 35000, minSkillLevelL3: 60, incomePerMemberL3: 14000, upgradeCostL2toL3: 100000 },
  { name: "Moonshine Operation", description: "Run an illegal distillery. Bootleg liquor sales.", skillId: chemSkill.id, minSkillLevel: 10, dailyTaskType: "crime" as const, dailyTaskDescription: "Commit any crime", incomePerMemberL1: 6000, minSkillLevelL2: 30, incomePerMemberL2: 14000, upgradeCostL1toL2: 60000, minSkillLevelL3: 55, incomePerMemberL3: 28000, upgradeCostL2toL3: 180000 },
  { name: "Fence Network", description: "Sell stolen goods through an underground distribution chain.", skillId: ssSkill.id, minSkillLevel: 10, dailyTaskType: "crime" as const, dailyTaskDescription: "Commit any crime", incomePerMemberL1: 4000, minSkillLevelL2: 28, incomePerMemberL2: 9000, upgradeCostL1toL2: 40000, minSkillLevelL3: 50, incomePerMemberL3: 18000, upgradeCostL2toL3: 120000 },
  { name: "Escort Agency", description: "Premium adult entertainment service for high-end clientele.", skillId: wsSkill.id, minSkillLevel: 10, dailyTaskType: "crime" as const, dailyTaskDescription: "Commit any crime", incomePerMemberL1: 2000, minSkillLevelL2: 28, incomePerMemberL2: 5000, upgradeCostL1toL2: 25000, minSkillLevelL3: 50, incomePerMemberL3: 10000, upgradeCostL2toL3: 80000 },
  { name: "Adult Entertainment Studio", description: "Produce and distribute adult content online.", skillId: seSkill.id, minSkillLevel: 12, dailyTaskType: "crime" as const, dailyTaskDescription: "Commit any crime", incomePerMemberL1: 10000, minSkillLevelL2: 30, incomePerMemberL2: 22000, upgradeCostL1toL2: 90000, minSkillLevelL3: 55, incomePerMemberL3: 45000, upgradeCostL2toL3: 280000 },
  { name: "Arms Trafficking Ring", description: "Smuggle illegal weapons across state lines.", skillId: gwSkill.id, minSkillLevel: 20, dailyTaskType: "pvp_win" as const, dailyTaskDescription: "Win any PvP attack", incomePerMemberL1: 25000, minSkillLevelL2: 40, incomePerMemberL2: 55000, upgradeCostL1toL2: 300000, minSkillLevelL3: 65, incomePerMemberL3: 110000, upgradeCostL2toL3: 750000 },
  { name: "Money Laundering Front", description: "Legitimate businesses used to clean dirty money.", skillId: chemSkill.id, minSkillLevel: 18, dailyTaskType: "deposit_vault" as const, dailyTaskDescription: "Deposit cash to the gang vault", incomePerMemberL1: 12000, minSkillLevelL2: 38, incomePerMemberL2: 26000, upgradeCostL1toL2: 110000, minSkillLevelL3: 60, incomePerMemberL3: 52000, upgradeCostL2toL3: 350000 },
  { name: "Safe Cracking Crew", description: "Professional heist team targeting safes and vaults.", skillId: ssSkill.id, minSkillLevel: 20, dailyTaskType: "crime" as const, dailyTaskDescription: "Commit any crime", incomePerMemberL1: 15000, minSkillLevelL2: 40, incomePerMemberL2: 35000, upgradeCostL1toL2: 150000, minSkillLevelL3: 65, incomePerMemberL3: 70000, upgradeCostL2toL3: 450000 },
  { name: "Casino Scam Ring", description: "Run sophisticated cons on underground gambling dens.", skillId: wsSkill.id, minSkillLevel: 15, dailyTaskType: "pvp_win" as const, dailyTaskDescription: "Win a mugging or ambush PvP attack", incomePerMemberL1: 8000, minSkillLevelL2: 32, incomePerMemberL2: 18000, upgradeCostL1toL2: 75000, minSkillLevelL3: 55, incomePerMemberL3: 35000, upgradeCostL2toL3: 220000 },
  { name: "Underground Fighting Ring", description: "Organize and profit from bare-knuckle brawls.", skillId: seSkill.id, minSkillLevel: 18, dailyTaskType: "train_skill" as const, dailyTaskDescription: "Train your Sexual Education skill 3 times", incomePerMemberL1: 18000, minSkillLevelL2: 35, incomePerMemberL2: 40000, upgradeCostL1toL2: 200000, minSkillLevelL3: 60, incomePerMemberL3: 80000, upgradeCostL2toL3: 550000 },
];
...
// Insert operation requirements (multi-skill)
const operationReqs: { opName: string; reqs: { skillId: number; minLevel: number; sortOrder: number }[] }[] = [
  { opName: "Escort Agency", reqs: [
    { skillId: wsSkill.id, minLevel: 10, sortOrder: 0 },
    { skillId: seSkill.id, minLevel: 8, sortOrder: 1 },
  ]},
  { opName: "Street Protection Racket", reqs: [
    { skillId: gwSkill.id, minLevel: 14, sortOrder: 0 },
    { skillId: chemSkill.id, minLevel: 12, sortOrder: 1 },
  ]},
  { opName: "Fence Network", reqs: [
    { skillId: ssSkill.id, minLevel: 12, sortOrder: 0 },
    { skillId: wsSkill.id, minLevel: 12, sortOrder: 1 },
  ]},
  { opName: "Moonshine Operation", reqs: [
    { skillId: chemSkill.id, minLevel: 18, sortOrder: 0 },
    { skillId: gwSkill.id, minLevel: 14, sortOrder: 1 },
    { skillId: ssSkill.id, minLevel: 10, sortOrder: 2 },
  ]},
  { opName: "Casino Scam Ring", reqs: [
    { skillId: wsSkill.id, minLevel: 18, sortOrder: 0 },
    { skillId: ssSkill.id, minLevel: 16, sortOrder: 1 },
    { skillId: seSkill.id, minLevel: 14, sortOrder: 2 },
  ]},
  { opName: "Adult Entertainment Studio", reqs: [
    { skillId: seSkill.id, minLevel: 20, sortOrder: 0 },
    { skillId: wsSkill.id, minLevel: 18, sortOrder: 1 },
    { skillId: chemSkill.id, minLevel: 16, sortOrder: 2 },
  ]},
  { opName: "Money Laundering Front", reqs: [
    { skillId: chemSkill.id, minLevel: 24, sortOrder: 0 },
    { skillId: ssSkill.id, minLevel: 20, sortOrder: 1 },
    { skillId: gwSkill.id, minLevel: 18, sortOrder: 2 },
  ]},
  { opName: "Safe Cracking Crew", reqs: [
    { skillId: ssSkill.id, minLevel: 25, sortOrder: 0 },
    { skillId: gwSkill.id, minLevel: 22, sortOrder: 1 },
    { skillId: chemSkill.id, minLevel: 20, sortOrder: 2 },
    { skillId: seSkill.id, minLevel: 16, sortOrder: 3 },
  ]},
  { opName: "Underground Fighting Ring", reqs: [
    { skillId: gwSkill.id, minLevel: 28, sortOrder: 0 },
    { skillId: seSkill.id, minLevel: 24, sortOrder: 1 },
    { skillId: wsSkill.id, minLevel: 22, sortOrder: 2 },
    { skillId: chemSkill.id, minLevel: 18, sortOrder: 3 },
  ]},
  { opName: "Arms Trafficking Ring", reqs: [
    { skillId: gwSkill.id, minLevel: 32, sortOrder: 0 },
    { skillId: chemSkill.id, minLevel: 28, sortOrder: 1 },
    { skillId: ssSkill.id, minLevel: 25, sortOrder: 2 },
    { skillId: seSkill.id, minLevel: 22, sortOrder: 3 },
    { skillId: wsSkill.id, minLevel: 18, sortOrder: 4 },
  ]},
];
...
const skillCrimes = [
  { name: "Lockpicking", description: "Pick the lock on a secure safe. Steady hands needed.", minLevel: 3, turnCost: 3, rewardMin: 200, rewardMax: 600, timingSpeed: 1.0 },
  { name: "Pickpocketing", description: "Lift wallets from a crowded subway. Quick reflexes required.", minLevel: 8, turnCost: 4, rewardMin: 500, rewardMax: 1500, timingSpeed: 1.5 },
  { name: "Safe Cracking", description: "Crack a bank vault's combination lock under time pressure.", minLevel: 15, turnCost: 8, rewardMin: 2000, rewardMax: 8000, timingSpeed: 2.2 },
  { name: "Data Heist", description: "Infiltrate a corporate server room and steal encrypted data.", minLevel: 25, turnCost: 12, rewardMin: 8000, rewardMax: 25000, timingSpeed: 3.0 },
];
